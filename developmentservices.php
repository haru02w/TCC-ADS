<?php
    ...
    $stmt = mysqli_prepare($conn, "SELECT *,SubString(DESCRIPTION,1,180) as DESC2 FROM TB_SERVICES S JOIN TB_CATEGORY C ON (C.ID_CATEGORY = S.COD_CATEGORY) WHERE COD_$type = ? AND STATUS = 2");
