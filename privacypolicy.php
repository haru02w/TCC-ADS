...
<br>
    <section class="section">
        <div class="container">
            <h1 class="title has-text-centered">Politica de privacidade e Termos de Uso <b class="has-text-link">Hatchfy</b></h1>
            ...
            <div class="content">
                <h2>Política Privacidade <b class="has-text-link">Hatchfy</b></h2>
                <p>A sua privacidade é importante para nós. É política do HatchFy respeitar a sua privacidade em
                    relação a qualquer informação sua que possamos coletar no site
                    <a href=https://hatchfy.philadelpho.tk>HatchFy</a>, e
                ...
                <h2>Política de Cookies <b class="has-text-link">HatchFy</b></h2>
            ...
            <ul>
                ...
                <li> Periodicamente, testamos novos recursos e fazemos alterações subtis na maneira como o site se
                    ...
                    você receba.
            <div class="content">
                <h2><br>Termos de Uso <b class="has-text-link">Hatchfy</b></h2>
                <h2>1. Termos</h2>
                    <p>Ao acessar ao site <a href='https://hatchfy.philadelpho.tk/'>HatchFy</a>, concorda em cumprir
                       estes termos de
